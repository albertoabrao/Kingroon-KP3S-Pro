...
#define STRING_CONFIG_H_AUTHOR "(albertoabrao)" // Who made the changes.
...
#define PID_K1 0.95       // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  14.81,  14.81 }
    #define DEFAULT_Ki_LIST {   1.10,   1.10 }
    #define DEFAULT_Kd_LIST {  49.76,  49.76 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 200.47
  #define DEFAULT_bedKi 37.97
  #define DEFAULT_bedKd 705.67
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 33.0, 5.0, 0 }
...
//
#define PREHEAT_1_LABEL       "Bed Leveling"
